...
Node* CreatorTest1_create()
{
    ...
    // New node
    auto sprite_1_3 = Sprite::createWithSpriteFrameName("grossini_dance_08");
    ...
    // New node
    auto sprite_1_4 = Sprite::createWithSpriteFrameName("grossini_dance_08");
    ...
    sprite_1_7->setName("empty_sprite");
    ...
    sprite_1_7->setTag(-1);
    sprite_1_7->setPosition(Vec2(50, 34));
